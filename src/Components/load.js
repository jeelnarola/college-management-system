...
const asideHeader = () =>{
    return`
    <aside id="default-sidebar" class="fixed top-0 left-0 z-20 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <h1 class="uppercase tracking-widest text-2xl  text-gray-50 mt-5">admin panel</h1>
       <ul class="space-y-2 font-medium">
          <li>
             <a href="http://127.0.0.1:5500/src/index.html" class="mt-6 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
